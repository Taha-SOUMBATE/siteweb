...
<section className="my-5">
  <div className="justify-between md:flex md:flex-row text-xl">
    <div className="w-full md:w-1/2 lg:w-1/3 text-start">
      ...
      <h2 className="text-orange-400 hover:text-orange-100 bg-orange-100 hover:bg-orange-400 w-1/4 md:w-3/4 p-1 rounded-lg">métiers de la Tech</h2>
    ...
    <div id="carouselExampleRide" className="carousel slide w-1/4 md:w-1/2 lg:w-1/3 me-4" data-bs-ride="true">
      <div className="carousel-inner">
        {photo.map((photos, index) => (
          <div key={photos.id} className={`carousel-item ${index === 0 ? 'active' : ''}`}>
            <img src={photos.pick} className="d-block w-full" alt="" />
          </div>
        ))}
      </div>
